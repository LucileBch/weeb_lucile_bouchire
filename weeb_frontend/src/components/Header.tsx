...
export function Header(): React.JSX.Element {
  ...
  return (
    <header className="sticky top-0 z-50 container py-4">
      <div className="flex w-full items-center justify-between rounded-[16px] bg-current/9 p-3 backdrop-blur-xl md:rounded-[20px] md:p-4">
        <Link
